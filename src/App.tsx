...
function App() {
  ...
  const [emailsToInvite, setEmailsToInvite] = useState(['camilafernanda914@gmail.com']);

  function optionGuestsInput(){
    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
       ...
       <div className='flex flex-col items-center gap-3'>
        <img className='w-52' src="/logo.svg" alt="plann.er" />
        ...
        <p className="text-zinc-500 text-sm">
          ...
          nossos <a className="text-zinc-300 underline" href="#">termos de uso</a> e <a className="text-zinc-300 underline" href="#">políticas de privacidade</a>.
        </p>
          ...
          <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
            <div className='w-[640px] rounded-xl py-5 px-6 shadow-shapeShadow bg-zinc-900 space-y-5'>
              ...
              <form onSubmit={addNewEmailToInvite} className='p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
                <AtSign className='text-zinc-400 size-5 mx-2' />
